...
#ifndef SXML_DOM_CHARACTER_DATA_INCLUDED
#define SXML_DOM_CHARACTER_DATA_INCLUDED
#include <sxml/dom/Node.hpp>

namespace sxml { namespace dom {

SXML_DOM_API std::u32string XmlCharDataEscape(const std::u32string& charData);

class SXML_DOM_API CharacterData : public Node
{
public:
...
class SXML_DOM_API Text : public CharacterData
{
public:
    Text();
...
class SXML_DOM_API EntityReference : public CharacterData
{
public:
    EntityReference();
...
class SXML_DOM_API CDataSection : public Text
{
public:
    CDataSection();
...
class SXML_DOM_API Comment : public CharacterData
{
public:
    Comment();
...
class SXML_DOM_API ProcessingInstruction : public Node
{
public:
...
#endif // SXML_DOM_CHARACTER_DATA_INCLUDED
