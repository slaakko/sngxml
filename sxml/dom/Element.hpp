...
#ifndef SXML_DOM_ELEMENT_INCLUDED
#define SXML_DOM_ELEMENT_INCLUDED
#include <sxml/dom/Node.hpp>
#include <map>

namespace sxml { namespace dom {

class SXML_DOM_API Attr : public Node
{
public:
    Attr();
...
class SXML_DOM_API Element : public ParentNode
{
public:
...
#endif // SXML_DOM_ELEMENT_INCLUDED
