...
#ifndef SXML_DOM_NODE_INCLUDED
#define SXML_DOM_NODE_INCLUDED
...
SXML_DOM_API std::u32string AxisName(Axis axis);

class SXML_DOM_API Node
{
public:
...
class SXML_DOM_API ParentNode : public Node
{
public:
