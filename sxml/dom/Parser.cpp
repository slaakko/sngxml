...
#include <sxml/dom/Parser.hpp>
#include <sxml/dom/Element.hpp>
#include <sxml/dom/CharacterData.hpp>
...
using namespace sxml::xml;
using namespace soulng::util;
using namespace soulng::unicode;

class SXML_DOM_API DomDocumentHandler : public XmlContentHandler
{
public:
    DomDocumentHandler();
