...
#ifndef SXML_XML_XML_CONTENT_HANDLER
#define SXML_XML_XML_CONTENT_HANDLER
...
class SXML_XML_API XmlContentHandler
{
public:
...
#endif // SXML_XML_XML_CONTENT_HANDLER
