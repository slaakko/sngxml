...
void XmlParser::Parse(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    ++lexer;
...
soulng::parser::Match XmlParser::Document(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::Prolog(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::XMLDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::VersionInfo(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::VersionNum(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    Span s = Span();
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::VersionNumDQ(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::VersionNumSQ(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::VersionNumber(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::EncodingDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::EncodingName(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    Span s = Span();
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::EncNameDQ(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::EncNameSQ(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::EncName(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::SDDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::DocTypeDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::IntSubset(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(true);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::MarkupDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::DeclSep(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::ElementDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::AttlistDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::unique_ptr<soulng::parser::Value<std::u32string>> name;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::AttDef(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::unique_ptr<soulng::parser::Value<std::u32string>> name;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::DefaultDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::EntityDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::GEDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::PEDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::EntityDef(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::PEDef(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::EntityValue(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::PEReference(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::unique_ptr<soulng::parser::Value<std::u32string>> name;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::NotationDecl(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::unique_ptr<soulng::parser::Value<std::u32string>> name;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::Element(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::ETag(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::unique_ptr<soulng::parser::Value<std::u32string>> name;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::Content(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::CharData(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::CDSect(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::u32string s = std::u32string();
    std::unique_ptr<soulng::parser::Value<char32_t>> chr;
    soulng::parser::Match match(false);
...
soulng::parser::Match XmlParser::Attribute(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::AttValueDQ(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::AttValueSQ(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::AttValue(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::EntityRef(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::unique_ptr<soulng::parser::Value<std::u32string>> name;
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
...
soulng::parser::Match XmlParser::CharRef(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
...
soulng::parser::Match XmlParser::Reference(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::Misc(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    soulng::parser::Match match(false);
    soulng::parser::Match* parentMatch0 = &match;
    {
...
soulng::parser::Match XmlParser::Comment(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
    std::u32string s = std::u32string();
    std::unique_ptr<soulng::parser::Value<char32_t>> chr;
    soulng::parser::Match match(false);
...
soulng::parser::Match XmlParser::PI(TrivialLexer& lexer, sxml::xml::XmlProcessor* processor)
{
