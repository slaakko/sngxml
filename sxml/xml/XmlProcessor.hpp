...
#ifndef SXML_XML_XML_PROCESSOR
#define SXML_XML_XML_PROCESSOR
...
class SXML_XML_API XmlProcessingException : public std::runtime_error
{
public:
    XmlProcessingException(const std::string& message);
};

class SXML_XML_API Entity
{
public:
    virtual ~Entity();
...
class SXML_XML_API InternalEntity : public Entity
{
public:
...
class SXML_XML_API XmlProcessor
{
public:
    ...
    XmlProcessor(TrivialLexer& lexer_, const char32_t* contentStart_, const char32_t* contentEnd_, XmlContentHandler* contentHandler_);
